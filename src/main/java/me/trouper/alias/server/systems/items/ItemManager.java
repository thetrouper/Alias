package me.trouper.alias.server.systems.items;

import com.google.gson.Gson;
import me.trouper.alias.server.Main;
import me.trouper.alias.server.systems.builders.ItemBuilder;
...
public class ItemManager implements Main {
    ...
    public static NamespacedKey registerItem(String namespace, Supplier<CustomItem> context) {
        NamespacedKey key = new NamespacedKey(main.getPlugin(), "items/" + namespace);
